...
<body>
    <div class="container">
        ...
        <h2 style="text-align:center;color:#00506E">Identidad validada correctamente</h2>

        <p>Se ha validado la identidad de un canje por parte de un cliente, los datos validados corresponden a:</p>
